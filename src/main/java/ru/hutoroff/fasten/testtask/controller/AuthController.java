...
import ru.hutoroff.fasten.testtask.service.data.auth.request.RequestMessage;
import ru.hutoroff.fasten.testtask.service.data.auth.response.ErrorResponseMessage;
import ru.hutoroff.fasten.testtask.service.data.auth.response.ResponseMessage;
import ru.hutoroff.fasten.testtask.service.data.auth.response.SuccessResponseMessage;
